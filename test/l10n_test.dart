...
void main() {
  ...
  test('sürüm numarası tutarlı (teknik 10.2.0, About gösterimi 10)', () {
    // Teknik sürüm: pubspec + Windows installer AppVersion = 10.2.0(+N)
    ...
    expect(
      installer,
      contains('#define AppVersion "10.2.0"'),
