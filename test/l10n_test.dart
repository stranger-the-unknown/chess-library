...
void main() {
  ...
  test('sürüm numarası tutarlı (teknik 10.0.3, About gösterimi 10)', () {
    // Teknik sürüm: pubspec + Windows installer AppVersion = 10.0.3(+N)
    ...
    expect(
      installer,
      contains('#define AppVersion "10.0.3"'),
