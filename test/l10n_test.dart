...
void main() {
  ...
  test('sürüm numarası tutarlı (teknik 9.0.2, About gösterimi 9)', () {
    // Teknik sürüm: pubspec + Windows installer AppVersion = 9.0.2(+N)
    ...
    expect(
      installer,
      contains('#define AppVersion "9.0.2"'),
