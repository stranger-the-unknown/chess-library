...
void main() {
  ...
  test('sürüm numarası tutarlı (teknik 10.4.0, About gösterimi 10)', () {
    // Teknik sürüm: pubspec + Windows installer AppVersion = 10.4.0(+N)
    ...
    expect(
      installer,
      contains('#define AppVersion "10.4.0"'),
  ...
  test('karşılıksız metin anahtarı yok', () {
    ...
    //
    // Bazı anahtarlar çalışma anında kuruluyor (`t('level.$key.name')`);
