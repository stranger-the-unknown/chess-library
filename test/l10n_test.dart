...
void main() {
  ...
  test('sürüm numarası tutarlı (teknik 10.0.5, About gösterimi 10)', () {
    // Teknik sürüm: pubspec + Windows installer AppVersion = 10.0.5(+N)
    ...
    expect(
      installer,
      contains('#define AppVersion "10.0.5"'),
